...
- add verifier legitimacy use case
...
- recognise npm provenance attestations
...
- add companion evidence collectors
...
- add companion evidence resolvers
...
- add companion evidence policy checks
...
- harden supported use-case recipes
...
- validate use-case profile definitions
...
- expose use-case safety boundaries
...
- canonicalise real-world profile subjects
